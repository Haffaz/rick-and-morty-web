...
export default function ResultPage() {
    ...
    if (error) return <div className="text-center text-red-600 mt-8">Error: {error.message}</div>;
            ...
            <div className="bg-white shadow-xl rounded-lg overflow-hidden">
                <div className="md:flex">
                    <div className="md:flex-shrink-0">
                        <img src={character?.image} alt={character?.name} className="h-48 w-full object-cover md:w-48" />
                    </div>
                    <div className="p-8">
